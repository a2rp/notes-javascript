import{j as e}from"./index-DhSfFbXE.js";import{S as s,O as r}from"./index-DNpKkLIV.js";import{B as n}from"./Breadcrumbs-DQYxiy7w.js";function i(){return e.jsxs(s.Wrapper,{children:[e.jsx(n,{sectionLabel:"Objects & Prototypes",sectionPath:"/objects-prototypes",topics:r}),e.jsx(s.Heading,{children:"Object utilities"}),e.jsxs(s.Prose,{children:[e.jsxs("p",{children:[e.jsx("b",{children:"Definition."})," Handy static helpers on ",e.jsx("code",{children:"Object"})," for reading keys, cloning/merging, converting to/from entries, and checking ownership. Most operate on"," ",e.jsx("i",{children:"own"})," properties only (not the prototype)."]}),e.jsx("h2",{children:"Keys / values / entries"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("code",{children:"Object.keys(o)"})," → own ",e.jsx("b",{children:"enumerable"})," string keys."]}),e.jsxs("li",{children:[e.jsx("code",{children:"Object.values(o)"})," → matching values."]}),e.jsxs("li",{children:[e.jsx("code",{children:"Object.entries(o)"})," → array of ",e.jsx("code",{children:"[key, value]"})," pairs."]})]}),e.jsx(s.Pre,{children:`const o = { a: 1, b: 2 };
Object.keys(o);      // ["a","b"]
Object.values(o);    // [1,2]
