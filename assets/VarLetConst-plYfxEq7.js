import{j as e}from"./index-8u32w9KR.js";import{S as s}from"./styled-B7242J7m.js";import{B as n,L as r}from"./index-r3zDAhCy.js";function c(){return e.jsxs(s.Wrapper,{children:[e.jsx(n,{sectionLabel:"Language Fundamentals",sectionPath:"/language-fundamentals",topics:r}),e.jsx(s.Heading,{children:"var vs let vs const"}),e.jsxs(s.Prose,{children:[e.jsxs("p",{children:[e.jsx("b",{children:"Definition."})," Three ways to declare bindings:",e.jsx("b",{children:" var"})," (function-scoped, hoisted, re-declarable),",e.jsx("b",{children:" let"})," (block-scoped, reassignable),",e.jsx("b",{children:" const"})," (block-scoped, non-reassignable). Prefer ",e.jsx("b",{children:"const"})," → ",e.jsx("b",{children:"let"}),"; avoid ",e.jsx("b",{children:"var"}),"."]}),e.jsx("h2",{style:{margin:"28px 0 12px"},children:"Scope & lifetime"}),e.jsx(s.Pre,{children:`function demo() {
  if (true) {
