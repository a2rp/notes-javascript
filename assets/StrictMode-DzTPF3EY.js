import{j as e}from"./index-Cud8-B-g.js";import{S as s}from"./styled-ou-l2Jgl.js";import{B as i}from"./Breadcrumbs-BUXMDEQY.js";import{L as r}from"./index-B6WK1LZv.js";function o(){return e.jsxs(s.Wrapper,{children:[e.jsx(i,{sectionLabel:"Language Fundamentals",sectionPath:"/language-fundamentals",topics:r}),e.jsx(s.Heading,{children:"Strict mode"}),e.jsxs(s.Prose,{children:[e.jsxs("p",{children:[e.jsx("b",{children:"Definition."})," ",e.jsx("code",{children:'"use strict"'})," enables stricter, safer semantics: throws on silent errors, tighter ",e.jsx("code",{children:"this"})," rules, cleaner scoping. ",e.jsx("b",{children:"ES modules & class bodies are strict by default."})]}),e.jsx("h2",{style:{margin:"28px 0 12px"},children:"How to enable"}),e.jsx(s.Pre,{children:`"use strict";            // whole script (must be first statement)
