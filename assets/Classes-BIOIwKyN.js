import{j as e}from"./index-Cps9Yqi0.js";import{S as s,O as r}from"./index-_MRbf5X-.js";import{B as n}from"./Breadcrumbs-DTCNvS__.js";function o(){return e.jsxs(s.Wrapper,{children:[e.jsx(n,{sectionLabel:"Objects & Prototypes",sectionPath:"/objects-prototypes",topics:r}),e.jsx(s.Heading,{children:"Classes"}),e.jsxs(s.Prose,{children:[e.jsxs("p",{children:[e.jsx("b",{children:"Definition."})," ",e.jsx("code",{children:"class"})," is syntax sugar over prototypes. Instance methods live on"," ",e.jsx("code",{children:"C.prototype"}),"; ",e.jsx("code",{children:"static"})," members live on the constructor ",e.jsx("code",{children:"C"}),". Fields can be public or ",e.jsx("b",{children:"#private"}),"."]}),e.jsx("h2",{children:"Syntax essentials"}),e.jsx(s.Pre,{children:`class Counter {
